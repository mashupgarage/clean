...
export const Item = ({
  ...
  return (
    <div
      className={`m-10 flex size-[600px] flex-col rounded-3xl bg-white shadow-2xl shadow-slate-400 ${stateSelection ? (stateSelection === selection ? "outline outline-4 outline-green-600" : "opacity-60") : ""} `}
