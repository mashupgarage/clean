...
from dispenser.views import DispenserViewSet, StoreViewSet, VendingMachineViewSet, react_app, sales, kpay_auth, query_transaction
...
urlpatterns = [
    ...
    path("api/kpay_auth/", kpay_auth, name="kpay_auth"),
    path("api/query-transaction/", query_transaction, name="query-transaction"),
    # React app url
